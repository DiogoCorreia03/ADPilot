...
from adpilot_agent.util.nodes import _extract_tool_text
...
def test_format_run_summary_accounting():
    ...
    # Record tokens
    record_token_usage(metrics, usage_metadata={"total_tokens": 500, "input_tokens": 400, "output_tokens": 100})
    record_token_usage(metrics, usage_metadata={"total_tokens": 1200, "input_tokens": 1000, "output_tokens": 200})
